                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div class="text-center">
                            <div class="w-32 h-32 mx-auto overflow-hidden rounded-full">
                                <img src="{{ asset('images/kafi.jpg') }}" alt="Developer 1" class="w-full h-full object-cover">
                            </div>
                            <h4 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mt-4 mb-2">Khalid Al Kafi</h4>
                            <p class="text-gray-700 dark:text-gray-300 text-lg">Student</p>
                        </div>

                        <!-- Team Member 2 -->
                        <div class="text-center">
                            <div class="w-32 h-32 mx-auto overflow-hidden rounded-full">
                                <img src="{{ asset('') }}" alt="Developer 2" class="w-full h-full object-cover">
                            </div>
                            <h4 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mt-4 mb-2">Sabiha</h4>
                            <p class="text-gray-700 dark:text-gray-300 text-lg">Student</p>
                        </div>
                        ...
                        <div class="text-center">
                            <div class="w-32 h-32 mx-auto overflow-hidden rounded-full">
                                <img src="{{ asset('') }}" alt="Developer 3" class="w-full h-full object-cover">
                            </div>
                            <h4 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mt-4 mb-2">Azmain</h4>
                            <p class="text-gray-700 dark:text-gray-300 text-lg">Student</p>
                        </div>
                        ...
                        <div class="text-center flex flex-col items-center justify-center">
                            <div class="w-32 h-32 mx-auto overflow-hidden rounded-full">
                                <img src="{{ asset('') }}" alt="Developer 4" class="w-full h-full object-cover">
                            </div>
                            <h4 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mt-4 mb-2 text-center">Toha Hossain</h4>
                            <p class="text-gray-700 dark:text-gray-300 text-lg">Student</p>
                        </div>
